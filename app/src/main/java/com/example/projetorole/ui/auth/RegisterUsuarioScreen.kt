...
fun RegisterUsuarioScreen(
    ...
    viewModel: RegisterUsuarioViewModel = viewModel()
) {
    ...
    LaunchedEffect(uiState.success) {
        if (uiState.success) {
            ...
            snackbarHost.showSnackbar("Conta criada com sucesso")
            onRegisterSuccess()
        }
    }
    ...
    androidx.compose.material3.Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Seu nome (opcional)", color = Color(0xFF090040).copy(alpha = 0.6f)) },
                singleLine = true,
