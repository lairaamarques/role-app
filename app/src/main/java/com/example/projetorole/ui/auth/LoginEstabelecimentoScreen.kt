...
@Composable
fun LoginEstabelecimentoScreen(
    onNavigateToRegister: () -> Unit,
    onSwitchAccount: () -> Unit,
    onLoginSuccess: () -> Unit,
    viewModel: LoginEstabelecimentoViewModel = viewModel()
) {
    ...
    androidx.compose.material3.Scaffold(
        ...
        Column(
            ...
            Text("Entrar como parceiro", color = Color.White, fontSize = 26.sp, fontWeight = FontWeight.Bold)
            Spacer(Modifier.height(8.dp))
            Text("Gerencie seus eventos pelo app", color = Color.White.copy(alpha = 0.7f), fontSize = 16.sp)
